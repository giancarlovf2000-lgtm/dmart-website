...
export const STATIC_CATEGORIES = [
  ...
  },
  {
    ...
    name: 'Técnico',
    slug: 'tecnico',
    description: 'Técnico de Electricidad con PLC y Energía Renovable, Técnico de Mecánica Automotriz, Técnico de Refrigeración y Aire Acondicionado con PLC y Energía Renovable. Programas técnicos especializados.',
    color: '#7c3aed',
    icon: 'Wrench',
    sort_order: 4,
  },
